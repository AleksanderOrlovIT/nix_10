...
public class TriangleArea {
    ...
    public static double Application3(){
        ...
        if (x[0] == x[1] && y[0] == y[1] || x[0] == x[2] && y[0] == y[2] || x[1] == x[2] && y[1] == y[2]) {
            throw new RuntimeException("The same coordinates exception");
        }

        if (x[0] == x[1] && x[1] == x[2] || y[0] == y[1] && y[1] == y[2]) {
            throw new RuntimeException("The same horizontal or vertical line exception");
        }
        ...
        if ((slope1 == slope2 && slope1 == slope3)) {
            throw new RuntimeException("Points make line exception");
        }
        ...
        if (side1 + side2 < side3 || side1 + side3 < side2 || side2 + side3 < side1) {
            throw new RuntimeException("The triangle does`nt exist exception");
        }
